...
In addition to increasing the confidence in our results, a key benefit of the formalised proof in a proof assistant for constructive proof such as Agda is that the proof normalisation procedure defined by \Cref{thm:cut-elim} is executable.
