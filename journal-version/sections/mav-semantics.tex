...
\begin{defi}\label[defn]{defn:pomonoid}
...
\begin{defi}\label[defn]{defn:residual}
...
\begin{defi}\label[defn]{defn:star-autonomous}
...
\begin{defi}\label[defn]{defn:duoidal}
...
\begin{defi}\label[defn]{defn:mav-algebra}
...
\begin{prop}\label[prop]{prop:mav-algebra-consequences}
...
\begin{defi}\label[defn]{defn:mav-interpretation}
...
\begin{lem}\label[lem]{lem:dual-ok}
  For all $\vP$, $\sem{\vDual{\vP}} = \lnot \sem{\vP}$.
\end{lem}

\begin{thm}\label[thm]{thm:soundness}
...
\begin{defi}\label[defn]{defn:mav-frame}
...
\begin{rem}\label[remark]{remark:cka}
...
\begin{prop}\label[prop]{prop:nmav-frame}
...
\begin{defi}\label[defn]{defn:lower-set}
...
\begin{prop}\label[defn]{defn:lower-set-embed-monotone}
...
\begin{prop}\label[prop]{prop:day-construction}
...
\begin{prop}\label[prop]{prop:lower-set-duoidal}
...
\begin{defi}\label[defn]{defn:closed-lower-set}
...
\begin{prop}\label[prop]{prop:closed-eta-preserve-joins}
...
\begin{prop}\label[prop]{prop:closed-monoid-distrib}
...
\begin{prop}\label[prop]{prop:closed-monoid-duoidal}
...
\begin{defi}\label[defn]{defn:chu}
...
\begin{prop}\label[prop]{prop:chu-meets}
...
\begin{prop}\label[prop]{prop:chu-self-dual}
...
\begin{lem}\label[lem]{lem:duoidal-residual}
...
\begin{prop}\label[prop]{prop:chu-monoid-duoidal}
  If $(\bullet, i)$ is duoidal over $(\lhd, j)$ on $(A, \leq)$, and
...
\begin{thm}\label[thm]{thm:algebra-from-frame}
...
\begin{thm}\label[thm]{thm:mavframe-soundness}
