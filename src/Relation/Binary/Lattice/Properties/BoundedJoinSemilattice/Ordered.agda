...
module Relation.Binary.Lattice.Properties.BoundedJoinSemilattice.Ordered
  {c ℓ₁ ℓ₂} (J : BoundedJoinSemilattice c ℓ₁ ℓ₂) where

open BoundedJoinSemilattice J

open import Algebra.Definitions _≈_
open import Algebra.Ordered using (CommutativePomonoid; IsCommutativePomonoid)
open import Data.Product
open import Function.Base using (_∘_; flip)
open import Relation.Binary
open import Relation.Binary.Properties.Poset poset
open import Relation.Binary.Lattice.Properties.JoinSemilattice.Ordered joinSemilattice
