...
open import MAUVE.Symmetric Atom
...
⟦ `externalu ⟧step-ax = ⊤-⅋-distrib
⟦ `medialu   ⟧step-ax = ⊤-maximum _
⟦ `medialu2  ⟧step-ax = ⊤-maximum _
...
⟦ `coexternalu ⟧step-ax = ⊥-⊗-distrib
⟦ `comedialu   ⟧step-ax = 𝟘-minimum _
⟦ `comedialu2  ⟧step-ax = 𝟘-minimum _
