...
ideal-Tree-closed {I} `𝟘        = I .0-closed
...
private
  preserve-𝟘-helper : (c : Tree (L.η 𝟘)) → Σ[ d ∈ Tree L.⊥ ] (sum c ≤ᶜ sum d)
...
module DayDistributive
  ...
  ∙ᵗ-sum (leaf x Fx)  `𝟘           = C.trans (C.reflexive (Mon.comm _ _)) 𝟘-distrib
  ∙ᵗ-sum `𝟘           (leaf x x₁) = 𝟘-distrib
  ∙ᵗ-sum `𝟘           `𝟘          = 𝟘-distrib
  ∙ᵗ-sum `𝟘           (node d d₁) = 𝟘-distrib
