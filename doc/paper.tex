...
\usepackage{tikz}
\newlength{\vTensWidth}
\settowidth{\vTensWidth}{$\vlpa$}
\newlength{\vParrWidth}
\settowidth{\vParrWidth}{$\vlse$}
\newlength{\vOpWidth}
\pgfmathsetlength{\vOpWidth}{max(\vTensWidth,\vParrWidth)}

\def\vTens{%
  \ensuremath{%
    \mathbin{%
      \makebox[\vOpWidth][c]{\ensuremath{\mathnormal\vlte}}}}}
\def\vParr{%
  \ensuremath{%
    \mathbin{%
      \makebox[\vOpWidth][c]{\ensuremath{\mathnormal\vlpa}}}}}
\def\vPlus{%
  \ensuremath{%
    \mathbin{%
      \makebox[\vOpWidth][c]{\ensuremath{\mathnormal\vlor}}}}}
\def\vWith{%
  \ensuremath{%
    \mathbin{%
      \makebox[\vOpWidth][c]{\ensuremath{\mathnormal\vlan}}}}}
\def\vSeq{%
  \ensuremath{%
    \mathbin{%
      \makebox[\vOpWidth][c]{\ensuremath{\mathnormal\vlse}}}}}
\def\vTo{%
  \ensuremath{%
    \mathbin{%
      \makebox[\vOpWidth][c]{\ensuremath{\mathnormal\vlli}}}}}
