...
\NewDocumentCommand{\RuleLabel}{s o m}{%
  \IfValueTF{#2}{%
    \customlabel{Rule}{#2}{\textsc{#3}}%
    \IfBooleanF{#1}{\hypertarget{#2}{\textsc{#3}}}
  }{%
    \customlabel{Rule}{rule:#3}{\textsc{\MakeTitlecase{#3}}}%
    \IfBooleanF{#1}{\hypertarget{rule:#3}{\textsc{\MakeTitlecase{#3}}}}
  }}
...
\usepackage{tikz}
\newlength{\vParrWidth}
\settowidth{\vParrWidth}{$\parr$}
\newlength{\vSeqWidth}
\settowidth{\vSeqWidth}{$\triangleleft$}
\newlength{\vOpWidth}
\pgfmathsetlength{\vOpWidth}{max(\vParrWidth,\vSeqWidth)}

\def\vTens{%
  \ensuremath{%
    \mathbin{%
      \makebox[\vOpWidth][c]{\ensuremath{\mathnormal\otimes}}}}}
\def\vParr{%
  \ensuremath{%
    \mathbin{%
      \makebox[\vOpWidth][c]{\ensuremath{\mathnormal\parr}}}}}
\def\vPlus{%
  \ensuremath{%
    \mathbin{%
      \makebox[\vOpWidth][c]{\ensuremath{\mathnormal\oplus}}}}}
\def\vWith{%
  \ensuremath{%
    \mathbin{%
      \makebox[\vOpWidth][c]{\ensuremath{\mathnormal\with}}}}}
\def\vSeq{%
  \ensuremath{%
    \mathbin{%
      \makebox[\vOpWidth][c]{\ensuremath{\mathnormal\triangleleft}}}}}

% Contexts
\newcommand{\vEmpty}[0]{\ensuremath{\Box}}
...
\NewDocumentCommand{\vEquiv}{s}{%
  \ensuremath{%
    \mathrel{%
      % \equiv\IfBooleanTF{#1}{^\star}{}}}}
      \longleftrightarrow\IfBooleanTF{#1}{^\star}{}}}}
\NewDocumentCommand{\vInfer}{s}{%
  \ensuremath{%
    \mathrel{%
