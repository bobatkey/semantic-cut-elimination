...
\begin{frontmatter}
  ...
  \begin{abstract}
    ...
    connective, we cannot use Okada's Phase Space semantics and have
    to build the require model using closed lower sets and the Chu
    construction. As a consequence, we also develop soundness and
    completeness proofs of MAV (and BV) with respect to a certain
    class of models. We have mechanised all our proofs in the Agda
    proof assistant, which provides both assurance of their
    correctness as well as yielding an executable proof normalisation
    procedure.
  \end{abstract}
  \begin{keyword}
