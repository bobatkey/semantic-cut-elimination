...
\newlength{\vParrWidth}
\settowidth{\vParrWidth}{$\vParr$}

\def\vTens{%
  \ensuremath{%
    \mathbin{%
      \makebox[\vParrWidth][c]{\ensuremath{\mathnormal\otimes}}}}}
\def\vPlus{%
  \ensuremath{%
    \mathbin{%
      \makebox[\vParrWidth][c]{\ensuremath{\mathnormal\oplus}}}}}
\def\vWith{%
  \ensuremath{%
    \mathbin{%
      \makebox[\vParrWidth][c]{\ensuremath{\mathnormal\with}}}}}
\def\vSeq{%
  \ensuremath{%
    \mathbin{%
      \makebox[\vParrWidth][c]{\ensuremath{\mathnormal\,\,\!\triangleright}}}}}
