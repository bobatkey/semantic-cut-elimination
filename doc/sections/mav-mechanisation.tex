...
\end{center}
The formalisation uses setoids to represent sets, and reuses definitions from the Agda Standard Library~\cite{AgdaStdlib20} where appropriate. We have provided a guide to the mechanisation relating it to the Definitions, Propositions, and Theorems in the previous sections in \Cref{sec:table-of-statments}.
