...
The \cref{rule:Cut}, \cref{rule:CoLeft}, and \cref{rule:CoRight} rules introduce of new structures going left-to-right.
...
\begin{remark}
  ...
  Inferences rules are usually named with the combination of a letter and an up or down arrow, \eg \cref{rule:Axiom} and \cref{rule:Cut} are $\iD$ and $\iU$, respectively.
\end{remark}
