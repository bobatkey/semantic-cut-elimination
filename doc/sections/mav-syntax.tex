...
\begin{displaymath}
  ...
  \end{array}
\end{displaymath}
Usually, in BV and its extension, structures are considered equivalent modulo a decidable equality comprising duality, as given above, and the associativity, commutativity, and identity laws that ensure that $(\vSeq,\vUnit)$ forms a pomonoid, and $(\vTens,\vUnit)$ and $(\vParr,\vUnit)$ form commutative pomonoids.
\begin{displaymath}
  \begin{array}{
