...
A derivation is in \emph{normal form} if it does not use \cref{rule:Cut} and  use of \cref{rule:Axiom} is restricted to atoms.
\begin{displaymath}
  \begin{array}{lcl@{\hspace{0.5cm}}|@{\hspace{0.5cm}}l}
  ...
  \end{array}
\end{displaymath}
Usually, these restrictions correspond to the outcome cut elimination and identity expansion, respectively.
\begin{remark}
