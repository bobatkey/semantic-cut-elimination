...
\begin{remark}
  \bob{A frame is nearly two duoidal structures, except that we don't
    assume that $+$ is a monoid, nor is there a unit element for it.}
\end{remark}
...
\begin{proposition}
  \bob{self dual operators from pomonoids with $k \rhd k \leq k$ and $j \leq k$.}
\end{proposition}

\begin{proposition}
  \bob{duoidality is preserved.}
\end{proposition}
